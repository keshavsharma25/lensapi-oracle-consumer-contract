    ...
    ReentrancyGuard
{
    ...
    constructor() ERC1155("") {
        _setURI(
            0,
            "https://ipfs.io/ipfs/bafybeig3qysjfzt6v7eeassq6rb623nbolxgxi4grplklqxzl5va5vmj5m/Charmander.png"
        );
        _setURI(
            1,
            "https://ipfs.io/ipfs/bafybeihphmbcw5fmk3q3chj7u6z4kfhgelraqwjdyz7fbr622uuk6fpjva/Charmeleon.png"
        );
        _setURI(
            2,
            "https://ipfs.io/ipfs/bafybeibdrpypp6qrunummndqcpjrcix7ho7hmcucwnjs3ggndaheqsbkpy/Charizard.png"
        );
    }
    ...
    function evolveOrClaim(address _claimer, uint256 data) public {
        ...
        if (levelId == 2) {
            ...
            verifyMint(_claimer, 2, 1);
            _mint(_claimer, 2, 1, "");
        } else if (levelId == 1) {
            if (balanceOf(_claimer, 0) == 1) {
                _burn(_claimer, 0, 1);
            }
            verifyMint(_claimer, 1, 1);
            _mint(_claimer, 1, 1, "");
        } else if (levelId == 0) {
            claim(_claimer, 0, 1);
        }
